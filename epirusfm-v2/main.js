...
(function () {
  ...
  function initHero() {
    ...
    const mat = new THREE.PointsMaterial({
      color: 0x1A7CF0, size: 1.8, transparent: true, opacity: .75, sizeAttenuation: true
    });
    ...
    const lineMat = new THREE.LineBasicMaterial({
      color: 0x1A7CF0, transparent: true, opacity: .14
    });
    ...
    const sphere = new THREE.Mesh(
      ...
      new THREE.MeshBasicMaterial({ color: 0x00C8B4, transparent: true, opacity: .6 })
    );
    ...
    const goldSphere = new THREE.Mesh(
      ...
      new THREE.MeshBasicMaterial({ color: 0x5AABFF, transparent: true, opacity: .8 })
    );
